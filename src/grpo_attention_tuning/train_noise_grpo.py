...
def train(
    ...
    base_model: str = "output_dir/CDs_and_Vinyl/latent/checkpoint-770",  # the only required argument
    train_file: str = "data/train/CDs_and_Vinyl_5_2015-10-2018-11.csv",
    eval_file: str = "data/valid/CDs_and_Vinyl_5_2015-10-2018-11.csv",
    info_file: str = "data/info/CDs_and_Vinyl_5_2015-10-2018-11.txt",
    ...
    seed: int = 42,
    cutoff_len: int = 512,
    output_dir: str = "output_dir/CDs_and_Vinyl/grpo_test_debug",
    category: str = "CDs_and_Vinyl", # category name

    num_generations: int = 4, # grpo args
    beta: float = 0.01, # KL coefficient
    num_iterations: int = 1, # number of iterations
